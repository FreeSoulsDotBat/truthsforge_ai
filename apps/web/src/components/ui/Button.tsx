  ...
  "inline-flex items-center justify-center gap-2 transition disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        // Ação primária da marca: ember tingido, mono uppercase, com brilho ember (frame v4).
        primary:
          "h-9 rounded-md border px-3.5 font-mono text-[11px] font-semibold uppercase tracking-[0.12em] text-forge-amber border-[color-mix(in_srgb,var(--ember)_40%,transparent)] bg-[color-mix(in_srgb,var(--ember)_14%,var(--bg-card))] shadow-[0_8px_24px_-16px_var(--ember-glow)] hover:bg-[color-mix(in_srgb,var(--ember)_20%,var(--bg-card))]",
        // Secundária/discreta.
        ghost:
