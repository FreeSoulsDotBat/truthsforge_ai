...
def _f7_placement_nudge() -> str:
    ...
    return (
        ...
        "    CASANDO FACES por ROLE (top_planar|bottom_planar|largest) ou por\n"
        "    PREDICADO ({type:'cylindrical', radius_mm:R}). O backend ACHA a face\n"
        "    real medindo — você NUNCA copia token. (flush; vira componente+junta;\n"
        "    coaxial → align_axis.)\n"
