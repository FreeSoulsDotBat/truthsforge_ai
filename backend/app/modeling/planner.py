...
def _build_messages(
    ...
    *,
    ...
    system_prompt = (
        ...
        "    os knuckles como cilindros AO LONGO dessa aresta (o eixo do pino =\n"
        "    direção da aresta, normalmente horizontal), alternados entre corpo e\n"
        "    tampa; `combine_bodies` cada grupo no seu corpo; o pino = cilindro\n"
        "    fino passando por todos. Use `joint` revolute só se for montagem que\n"
        "    abre na tela (ela move os corpos para componentes não-combináveis).\n"
