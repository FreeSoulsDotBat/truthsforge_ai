...
def _build_messages(
    ...
    system_prompt = (
        ...
        "- Para ESFERA/CONE/VASO use `fusion.revolve_profile`: desenhe meio-perfil\n"
        "  (ex.: semicírculo via add_arc + add_line fechando no eixo) e revolva 360°.\n"
        "- Para PENTÁGONO/HEXÁGONO e afins use `fusion.add_polygon` (sides=5/6...).\n"
        "- Ordem típica de um corpo: create_sketch → add_<forma> → extrude/revolve.\n"
        "\n"
